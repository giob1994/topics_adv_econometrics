...
% In this case, a NONLINEAR constrain is necessary to properly identify
% the covariance matrix: it must be positive semidefinite!
%
% See: '@confuneq' from 'Solutions' folder

% [theta_mle, log_like_mle] = ...
%   fmincon(loglikeF, x0, [], [], Aeq, beq, lb, ub, @confuneq, options);
